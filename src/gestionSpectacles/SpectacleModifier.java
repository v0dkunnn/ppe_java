 ...
 * @author gaellecastel
 */
public class SpectacleModifier extends javax.swing.JFrame {

    private int lIndexDuSpectacle;
    ...
    public SpectacleModifier(int laLigneSelectionnee) {
        ...
        //dans la liste de droite on met les intermittents déjà choisis pour ce spectacle
        listeDroite.addAll(NezDamesSerialisation.lesSpectacles.get(laLigneSelectionnee).getLesIntermittents());
        ...
        //on remplit la liste de gauche avec les intermittents qui ne sont pas dans la liste de droite
        for (Intermittent unIntermittent : NezDamesSerialisation.lesIntermittents) {
            //on teste si l'intermittent est déjà dans la liste de droite
            trouve = false;
            for (Intermittent cetIntermittent : listeDroite) {
                if ((unIntermittent.getNomIntermittent().compareTo(cetIntermittent.getNomIntermittent()) == 0) && (unIntermittent.getPrenomIntermittent().compareTo(cetIntermittent.getPrenomIntermittent()) == 0)) {
                    trouve = true;
                }
            }
            if (!trouve) { //on ne remplit que si cet intermittent n'est pas déjà dans la liste de droite
                modeleGauche.addElement(unIntermittent.getNomIntermittent() + " " + unIntermittent.getPrenomIntermittent());
                listeGauche.add(unIntermittent);
            }
        }
    ...
    private void initComponents() {
        ...
        lblTitre1.setText("MODIFICATION D'UN SPECTACLE");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblImageManu, javax.swing.GroupLayout.Alignment.TRAILING))
        ...
        setSize(new java.awt.Dimension(785, 532));
                            ...
                            if (txtFichierContraintesTechniques.getText().compareTo("") == 0) {
                                ...
                                if (txtFichierSynopsis.getText().compareTo("") == 0) {
                                    ...
                                    if (listeDroite.size() == 0) {
                                        ...
                                        // modification du spectacle dans la collection lesSpectacless
                                        NezDamesSerialisation.lesSpectacles.get(lIndexDuSpectacle).modifier(txtNumeroObjet.getText(), Integer.parseInt(txtDuree.getText()), txtTitre.getText(), Integer.parseInt(txtAnneeCreation.getText()), Double.parseDouble(txtPrixVenteTheorique.getText()), txtFichierContraintesTechniques.getText(), txtFichierSynopsis.getText(), listeDroite);
                                        JOptionPane.showMessageDialog(null, "Spectacle modifié");
    ...
    private void jButtonAjouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAjouterActionPerformed
        ...
        for (Intermittent unIntermittent : listeGauche) {
            System.out.println(unIntermittent.getNomIntermittent());
        }
        //fin vérif
    ...
    private void jButtonRetirerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRetirerActionPerformed
        ...
        for (int i = 0; i < listeDroite.size(); i++) {
            ...
            if (chaine.compareTo(nomPrenom) == 0) { // c'est le bon intermittent
                ...
                //modeleGauche.removeElement(listeGauche.get(i));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpectacleModifier.class
        ...
        /* java.awt.EventQueue.invokeLater(new Runnable() {
         public void run() {
         new SpectacleModifier().setVisible(true);
         }
         });*/
    }
