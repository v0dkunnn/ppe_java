 ...
 * @author gaellecastel
 */
public class ContratCessionConfirmerEdition extends javax.swing.JFrame {

    private int indiceDuContratCessionAEditer;
    private String leContratCessionSelectionne;

    DefaultListModel modele = new DefaultListModel();

    public ContratCessionConfirmerEdition(String leContratCessionSelectionne) {
        initComponents();

        //pour que toute l'application ne se ferme pas quand on clique sur la croix rouge
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        
        this.leContratCessionSelectionne = leContratCessionSelectionne;

        //chargement du contrat de cession concernée
        txtNumero.setText(leContratCessionSelectionne);
    }
    ...
    private void initComponents() {
        ...
        lblTitre1.setText("Êtes vous de vouloir éditer ce contrat de cession ?");
    ...
    private void btnOuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOuiActionPerformed
        ...
        for (int i=0 ; i<NezDamesSerialisation.lesContratsCession.size() ; i++) {
            if (NezDamesSerialisation.lesContratsCession.get(i).getNumeroContratCession().compareTo(leContratCessionSelectionne)==0) {
                indiceDuContratCessionAEditer = i;
            }
        }
        new GenererPdfContratCession(indiceDuContratCessionAEditer);
        
        //modification de l'état d'édition du contrat de production
        NezDamesSerialisation.lesContratsCession.get(indiceDuContratCessionAEditer).setEdition(TRUE);
        
        //affichage de la confirmation
        JOptionPane.showMessageDialog(this, "Contrat de cession généré en PDF.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContratCessionConfirmerEdition.class
