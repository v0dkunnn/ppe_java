 ...
 * @author gaellecastel
 */
public class IntermittentConfirmerSuppression extends javax.swing.JFrame {

    private int indiceDeLIntermittentASupprimer;

    DefaultListModel modele = new DefaultListModel();

    public IntermittentConfirmerSuppression(int laLigneSelectionnee) {
        initComponents();

        //pour que toute l'application ne se ferme pas quand on clique sur la croix rouge
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        
        indiceDeLIntermittentASupprimer = laLigneSelectionnee;

        //chargement du nom de l'intermittent concerné
    ...
    private void initComponents() {
        ...
        lblTitre1.setText("Êtes vous de vouloir supprimer cet intermittent ?");
    ...
    private void btnOuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOuiActionPerformed
        ...
        NezDamesSerialisation.lesIntermittents.remove(indiceDeLIntermittentASupprimer);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntermittentConfirmerSuppression.class
